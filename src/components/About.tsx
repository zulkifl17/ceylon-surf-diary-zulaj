    ...
    <section ref={sectionRef} className="min-h-screen bg-background flex items-center">
      <div className="container mx-auto px-0">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
          ...
          <div ref={textRef} className="flex items-center justify-center p-8 lg:p-16 bg-background text-primary-text">
            <div className="max-w-xl">
              <h2 className="text-5xl md:text-7xl font-bold mb-8 leading-tight text-primary-text" style={{ fontFamily: 'Bebas Neue, Oswald, sans-serif', letterSpacing: '0.05em' }}>
                CAPTURING<br />THE SOUL<br />OF WELIGAMA
              </h2>
              <p className="text-lg md:text-xl leading-relaxed mb-6 text-primary-text">
                I capture the raw power of the ocean and the soul of Weligama's surf culture.
              </p>
              <p className="text-base md:text-lg leading-relaxed opacity-80 text-primary-text">
